...
!Define_SMAS_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(SMAS_E, !ROMID)
endmacro
...
macro SMAS_GlobalAssemblySettings()
	...
	!Define_Global_ReleaseDate = "December 16, 1993"
	!Define_Global_BaseROMMD5Hash = "669efc8aa7365b5854d3653ab5598dc9"
...
if !Define_Global_SMASGames&(!SMASGames_SMB1|!SMASGames_SMBLL|!SMASGames_SMB3) != $00
	...
	%ROUTINE_SMAS_IntroProcess1E_PlayerPressedStart(NULLROM)
