...
if !Define_Global_SMASGames&(!SMASGames_SMB1|!SMASGames_SMBLL|!SMASGames_SMB2U) != $00
	...
	%ROUTINE_SMAS_DisplayCopyDetectionErrorMessage($009509)
if !Define_Global_SMASGames&(!SMASGames_SMB1|!SMASGames_SMBLL|!SMASGames_SMB3) != $00
	%DATATABLE_SMAS_CircleHDMAData($0096FF)
endif
	%FREE_BYTES($009982, 510, $FF)
	...
	%ROUTINE_SMAS_HandleExtaTitleScreenMarioAndYoshiAnimation($00B62B)
