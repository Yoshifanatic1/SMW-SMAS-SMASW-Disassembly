; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SMB1_InsertIntegratedPatches and SMB1_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SMB1_InsertIntegratedPatches()
...
macro SMB1_ApplyPatchesPostAssembly()
