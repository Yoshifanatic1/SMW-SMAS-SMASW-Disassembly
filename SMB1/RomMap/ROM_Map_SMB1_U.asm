...
!Define_SMAS_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(SMB1_U, !ROMID)
endmacro
...
macro SMB1_GlobalAssemblySettings()
	...
	!Define_Global_BaseROMMD5Hash = "38c93291765e3eb520bfa29158566dc0"
