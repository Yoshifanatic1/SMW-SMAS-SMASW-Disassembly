...
echo Valid options: "SMB2U_U" "SMB2U_E" "SMB2U_J"
...
if "%Input1%" equ "SMB2U_U" goto :USA
if "%Input1%" equ "SMB2U_E" goto :PAL
if "%Input1%" equ "SMB2U_J" goto :Japan
...
:USA
set ROMVer=(U)
set ROMNAME=Super Mario Bros. 2
goto :Assemble
...
echo Assembling SMB2U SPC700 level music bank...
%asarVer% --define GameID="%GAMDID%" --define ROMID="%Input1%" --define FileType=4 --define PathToFile="SPC700/SMB2U_MusicBank.asm" ..\Global\AssembleFile.asm SPC700\SMB2U_MusicBank.bin
...
if exist SPC700\SMB2U_MusicBank.bin del SPC700\SMB2U_MusicBank.bin
