; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SMB2U_InsertIntegratedPatches and SMB2U_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SMB2U_InsertIntegratedPatches()
...
macro SMB2U_ApplyPatchesPostAssembly()
