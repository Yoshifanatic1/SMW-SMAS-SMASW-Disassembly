...
!Define_SMAS_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(SMB2U_E, !ROMID)
endmacro
...
macro SMB2U_GlobalAssemblySettings()
	...
	!Define_Global_BaseROMMD5Hash = "1c7888cf5f1364a44f6c0209f189db6c"
