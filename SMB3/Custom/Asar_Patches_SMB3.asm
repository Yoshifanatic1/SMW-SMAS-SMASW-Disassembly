; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SMB3_InsertIntegratedPatches and SMB3_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SMB3_InsertIntegratedPatches()
...
macro SMB3_ApplyPatchesPostAssembly()
