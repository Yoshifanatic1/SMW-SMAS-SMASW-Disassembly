...
echo Valid options: "SMBLL_U" "SMBLL_E" "SMBLL_J"
...
if "%Input1%" equ "SMBLL_U" goto :USA
if "%Input1%" equ "SMBLL_E" goto :PAL
if "%Input1%" equ "SMBLL_J" goto :Japan
...
:USA
set ROMVer=(U)
set ROMNAME=Super Mario Bros. The Lost Levels
goto :Assemble
...
:Japan
set ROMVer=(J)
set ROMNAME=Super Mario Bros. 2 (For Super Players)
