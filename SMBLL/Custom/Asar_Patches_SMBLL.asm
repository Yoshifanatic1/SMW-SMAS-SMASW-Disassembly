; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SMBLL_InsertIntegratedPatches and SMBLL_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SMBLL_InsertIntegratedPatches()
...
macro SMBLL_ApplyPatchesPostAssembly()
