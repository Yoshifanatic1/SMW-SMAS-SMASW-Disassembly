...
!Define_SMAS_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(SMBLL_J, !ROMID)
endmacro
...
macro SMBLL_GlobalAssemblySettings()
	...
	!Define_Global_BaseROMMD5Hash = "44fbfdd0dc03514d7a09d5f768cf5ff3"
	...
	!Define_Global_InternalName = "Super Mario Bros. 2  "
